      ...
      >
        ...
        >
          ...
          <el-form-item label="地址" prop="specified_address">
            <el-col :span="18">
              <el-input
                v-model="cinemaInfo.specified_address"
                type="textarea"
              ></el-input>
            </el-col>
          </el-form-item>
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="manageCinemaInfo()"
            >确 定</el-button
          >
        </div>
      </el-dialog>
  ...
  methods: {
    ...
    async manageCinemaInfo() {
      if (
        ...
        !this.cinemaInfo.cinema_phone ||
        !/^1[3|4|5|6|7|8][0-9]{9}$/.test(this.cinemaInfo.cinema_phone) ||
        !this.cinemaInfo.specified_address
      ) {
        Message.error("请完成必填内容！");
      } else {
        if (this.dialogTitle === "编辑影院信息") {
          let json = await updateCinemaInfo(
